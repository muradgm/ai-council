...
Evaluate system architecture options, tradeoffs, constraints, risks, and implementation paths.

## When to use this engine

Use this engine when the Council must make or review a **technical architecture decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Fitness To Problem**: score from 1-5 and justify the score.
- **Simplicity**: score from 1-5 and justify the score.
- **Scalability**: score from 1-5 and justify the score.
- **Maintainability**: score from 1-5 and justify the score.
- **Security Posture**: score from 1-5 and justify the score.
- **Delivery Risk**: score from 1-5 and justify the score.
- **Cost Of Change**: score from 1-5 and justify the score.
...
```md
# Architecture Engine Decision Memo
