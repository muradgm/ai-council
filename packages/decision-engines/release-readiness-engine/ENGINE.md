...
Evaluate whether a product, feature, or system is ready to ship safely.

## When to use this engine

Use this engine when the Council must make or review a **release decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Critical Bugs**: score from 1-5 and justify the score.
- **Rollback Plan**: score from 1-5 and justify the score.
- **Docs Updated**: score from 1-5 and justify the score.
- **Monitoring Ready**: score from 1-5 and justify the score.
- **Support Plan**: score from 1-5 and justify the score.
- **Security Checks**: score from 1-5 and justify the score.
- **Business Acceptance**: score from 1-5 and justify the score.
...
```md
# Release Readiness Engine Decision Memo
