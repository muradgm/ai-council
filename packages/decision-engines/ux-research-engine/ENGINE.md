...
Plan and interpret user research, usability checks, persona assumptions, and behavioral evidence.

## When to use this engine

Use this engine when the Council must make or review a **user research decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Research Question Clarity**: score from 1-5 and justify the score.
- **Sample Relevance**: score from 1-5 and justify the score.
- **Bias Control**: score from 1-5 and justify the score.
- **Evidence Quality**: score from 1-5 and justify the score.
- **Actionability**: score from 1-5 and justify the score.
- **Confidence Level**: score from 1-5 and justify the score.
- **Next Experiment**: score from 1-5 and justify the score.
...
```md
# UX Research Engine Decision Memo
