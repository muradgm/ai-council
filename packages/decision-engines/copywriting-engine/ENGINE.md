...
Evaluate message clarity, persuasion, tone, positioning, conversion logic, and audience fit.

## When to use this engine

Use this engine when the Council must make or review a **copy decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Specificity**: score from 1-5 and justify the score.
- **Audience Fit**: score from 1-5 and justify the score.
- **Benefit Strength**: score from 1-5 and justify the score.
- **Credibility**: score from 1-5 and justify the score.
- **Friction Reduction**: score from 1-5 and justify the score.
- **Call To Action**: score from 1-5 and justify the score.
...
```md
# Copywriting Engine Decision Memo
