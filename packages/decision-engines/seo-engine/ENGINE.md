...
Evaluate search strategy, keyword intent, content architecture, technical SEO, and discoverability.

## When to use this engine

Use this engine when the Council must make or review a **SEO decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Search Intent**: score from 1-5 and justify the score.
- **Keyword Fit**: score from 1-5 and justify the score.
- **Technical Health**: score from 1-5 and justify the score.
- **Content Depth**: score from 1-5 and justify the score.
- **Internal Linking**: score from 1-5 and justify the score.
- **Conversion Path**: score from 1-5 and justify the score.
