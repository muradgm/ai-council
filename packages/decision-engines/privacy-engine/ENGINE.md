...
Evaluate personal data flows, retention, consent, minimization, access control, and deletion logic.

## When to use this engine

Use this engine when the Council must make or review a **privacy decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Data Minimization**: score from 1-5 and justify the score.
- **Purpose Limitation**: score from 1-5 and justify the score.
- **Retention Clarity**: score from 1-5 and justify the score.
- **Access Controls**: score from 1-5 and justify the score.
- **Deletion Path**: score from 1-5 and justify the score.
- **User Transparency**: score from 1-5 and justify the score.
- **Auditability**: score from 1-5 and justify the score.
