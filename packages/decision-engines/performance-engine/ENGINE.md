...
Evaluate performance bottlenecks, load behavior, frontend speed, backend latency, and optimization tradeoffs.

## When to use this engine

Use this engine when the Council must make or review a **performance decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- No direct skill dependency configured yet.

## Owner / reviewer agents

- No direct agent owner configured yet.
...
- **Bottleneck Evidence**: score from 1-5 and justify the score.
- **User Impact**: score from 1-5 and justify the score.
- **Measurement Quality**: score from 1-5 and justify the score.
- **Complexity Cost**: score from 1-5 and justify the score.
- **Regression Risk**: score from 1-5 and justify the score.
- **Scalability**: score from 1-5 and justify the score.
- **Monitoring**: score from 1-5 and justify the score.
...
```md
# Performance Engine Decision Memo
