...
Evaluate agent roles, tool boundaries, memory, planning loops, safety, and orchestration design.

## When to use this engine

Use this engine when the Council must make or review a **AI agent architecture decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Tool Boundaries**: score from 1-5 and justify the score.
- **Context Loading**: score from 1-5 and justify the score.
- **Failure Handling**: score from 1-5 and justify the score.
- **Evaluation Plan**: score from 1-5 and justify the score.
- **Safety Limits**: score from 1-5 and justify the score.
...
```md
# AI Agent Design Engine Decision Memo
