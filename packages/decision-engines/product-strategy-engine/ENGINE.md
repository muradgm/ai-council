...
Evaluate product direction, feature priority, user value, positioning, and roadmap logic.

## When to use this engine

Use this engine when the Council must make or review a **product strategy decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **User Pain Clarity**: score from 1-5 and justify the score.
- **Differentiation**: score from 1-5 and justify the score.
- **Feasibility**: score from 1-5 and justify the score.
- **Time-To-Value**: score from 1-5 and justify the score.
- **Retention Potential**: score from 1-5 and justify the score.
- **Strategic Fit**: score from 1-5 and justify the score.
- **Learning Value**: score from 1-5 and justify the score.
...
```md
# Product Strategy Engine Decision Memo
