...
Review interface hierarchy, layout, interaction clarity, visual polish, and component consistency.

## When to use this engine

Use this engine when the Council must make or review a **interface quality decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Hierarchy**: score from 1-5 and justify the score.
- **Clarity**: score from 1-5 and justify the score.
- **Consistency**: score from 1-5 and justify the score.
- **Accessibility**: score from 1-5 and justify the score.
- **Responsiveness**: score from 1-5 and justify the score.
- **Visual Rhythm**: score from 1-5 and justify the score.
- **Component Reuse**: score from 1-5 and justify the score.
...
```md
# UI Review Engine Decision Memo
