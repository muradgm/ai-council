...
Evaluate documentation completeness, clarity, structure, onboarding value, and maintenance burden.

## When to use this engine

Use this engine when the Council must make or review a **documentation quality decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Audience Clarity**: score from 1-5 and justify the score.
- **Navigation**: score from 1-5 and justify the score.
- **Accuracy**: score from 1-5 and justify the score.
- **Examples**: score from 1-5 and justify the score.
- **Maintenance Ownership**: score from 1-5 and justify the score.
- **Decision Traceability**: score from 1-5 and justify the score.
- **Onboarding Speed**: score from 1-5 and justify the score.
...
```md
# Documentation Engine Decision Memo
