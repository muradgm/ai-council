...
Evaluate sales motions, qualification, objections, offers, outreach, and deal progression.

## When to use this engine

Use this engine when the Council must make or review a **sales strategy decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Buyer Fit**: score from 1-5 and justify the score.
- **Pain Qualification**: score from 1-5 and justify the score.
- **Offer Clarity**: score from 1-5 and justify the score.
- **Objection Coverage**: score from 1-5 and justify the score.
- **Next Step Strength**: score from 1-5 and justify the score.
- **Follow-Up Cadence**: score from 1-5 and justify the score.
- **Ethical Pressure**: score from 1-5 and justify the score.
