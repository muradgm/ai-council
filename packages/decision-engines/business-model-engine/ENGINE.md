...
Evaluate monetization models, revenue mechanics, pricing logic, margins, and operating constraints.

## When to use this engine

Use this engine when the Council must make or review a **business model decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Customer Willingness To Pay**: score from 1-5 and justify the score.
- **Margin Structure**: score from 1-5 and justify the score.
- **Repeatability**: score from 1-5 and justify the score.
- **Sales Complexity**: score from 1-5 and justify the score.
- **Cash Flow Timing**: score from 1-5 and justify the score.
- **Scalability**: score from 1-5 and justify the score.
- **Risk Concentration**: score from 1-5 and justify the score.
...
```md
# Business Model Engine Decision Memo
