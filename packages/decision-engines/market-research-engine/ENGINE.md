...
Analyze market categories, competitors, positioning gaps, customer segments, and evidence quality.

## When to use this engine

Use this engine when the Council must make or review a **market research decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Source Quality**: score from 1-5 and justify the score.
- **Market Definition**: score from 1-5 and justify the score.
- **Segment Clarity**: score from 1-5 and justify the score.
- **Competitor Relevance**: score from 1-5 and justify the score.
- **Gap Realism**: score from 1-5 and justify the score.
- **Timing Signal**: score from 1-5 and justify the score.
- **Uncertainty**: score from 1-5 and justify the score.
...
```md
# Market Research Engine Decision Memo
