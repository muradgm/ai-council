...
Identify security risks, abuse cases, unsafe defaults, data exposure, and mitigation priorities.

## When to use this engine

Use this engine when the Council must make or review a **security risk decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Asset Sensitivity**: score from 1-5 and justify the score.
- **Attack Surface**: score from 1-5 and justify the score.
- **Exploitability**: score from 1-5 and justify the score.
- **Impact**: score from 1-5 and justify the score.
- **Mitigation Clarity**: score from 1-5 and justify the score.
- **Logging**: score from 1-5 and justify the score.
- **Least Privilege**: score from 1-5 and justify the score.
...
```md
# Security Review Engine Decision Memo
