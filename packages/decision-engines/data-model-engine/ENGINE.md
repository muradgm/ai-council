...
Evaluate domain models, entity relationships, schema design, data ownership, and migration risk.

## When to use this engine

Use this engine when the Council must make or review a **data model decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Domain Fit**: score from 1-5 and justify the score.
- **Normalization Balance**: score from 1-5 and justify the score.
- **Query Patterns**: score from 1-5 and justify the score.
- **Migration Safety**: score from 1-5 and justify the score.
- **Data Integrity**: score from 1-5 and justify the score.
- **Privacy**: score from 1-5 and justify the score.
- **Future Extension**: score from 1-5 and justify the score.
...
```md
# Data Model Engine Decision Memo
