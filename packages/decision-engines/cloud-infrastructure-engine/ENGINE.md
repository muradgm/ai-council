...
Evaluate cloud architecture, service choices, costs, reliability, scaling, and security defaults.

## When to use this engine

Use this engine when the Council must make or review a **cloud infrastructure decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Managed-Service Fit**: score from 1-5 and justify the score.
- **Security Defaults**: score from 1-5 and justify the score.
- **Reliability Targets**: score from 1-5 and justify the score.
- **Scaling Path**: score from 1-5 and justify the score.
- **Cost Visibility**: score from 1-5 and justify the score.
- **Vendor Lock-In**: score from 1-5 and justify the score.
- **Operational Burden**: score from 1-5 and justify the score.
...
```md
# Cloud Infrastructure Engine Decision Memo
