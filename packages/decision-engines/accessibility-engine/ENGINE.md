...
Review accessibility, inclusive design, keyboard flow, semantic structure, contrast, and assistive technology fit.

## When to use this engine

Use this engine when the Council must make or review a **accessibility decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Semantic Structure**: score from 1-5 and justify the score.
- **Keyboard Usability**: score from 1-5 and justify the score.
- **Contrast**: score from 1-5 and justify the score.
- **Focus States**: score from 1-5 and justify the score.
- **Error Messages**: score from 1-5 and justify the score.
- **Assistive Tech Support**: score from 1-5 and justify the score.
- **Inclusive Interaction**: score from 1-5 and justify the score.
...
```md
# Accessibility Engine Decision Memo
