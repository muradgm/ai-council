...
Evaluate acquisition loops, channels, experiments, retention levers, and growth bottlenecks.

## When to use this engine

Use this engine when the Council must make or review a **growth strategy decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Channel Fit**: score from 1-5 and justify the score.
- **Experiment Clarity**: score from 1-5 and justify the score.
- **Measurement Quality**: score from 1-5 and justify the score.
- **Cost Efficiency**: score from 1-5 and justify the score.
- **Retention Leverage**: score from 1-5 and justify the score.
- **Speed Of Learning**: score from 1-5 and justify the score.
- **Compounding Potential**: score from 1-5 and justify the score.
