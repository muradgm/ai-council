...
Evaluate AI workflows for harmful misuse, overclaiming, unsafe automation, privacy leakage, and high-stakes boundaries.

## When to use this engine

Use this engine when the Council must make or review a **AI safety decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Harm Potential**: score from 1-5 and justify the score.
- **User Stakes**: score from 1-5 and justify the score.
- **Autonomy Level**: score from 1-5 and justify the score.
- **Data Sensitivity**: score from 1-5 and justify the score.
- **Misuse Risk**: score from 1-5 and justify the score.
- **Human Review Need**: score from 1-5 and justify the score.
- **Guardrail Clarity**: score from 1-5 and justify the score.
...
```md
# AI Safety Engine Decision Memo
