...
Review implementation quality, correctness, maintainability, readability, and integration risk.

## When to use this engine

Use this engine when the Council must make or review a **code quality decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Correctness**: score from 1-5 and justify the score.
- **Clarity**: score from 1-5 and justify the score.
- **Type Safety**: score from 1-5 and justify the score.
- **Error Handling**: score from 1-5 and justify the score.
- **Testability**: score from 1-5 and justify the score.
- **Integration Risk**: score from 1-5 and justify the score.
- **Reuse Of Existing Code**: score from 1-5 and justify the score.
...
```md
# Code Review Engine Decision Memo
