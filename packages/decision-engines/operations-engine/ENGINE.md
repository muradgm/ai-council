...
Evaluate workflows, handoffs, responsibilities, bottlenecks, SOPs, and operational reliability.

## When to use this engine

Use this engine when the Council must make or review a **operations decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Role Clarity**: score from 1-5 and justify the score.
- **Handoff Quality**: score from 1-5 and justify the score.
- **Failure Recovery**: score from 1-5 and justify the score.
- **Measurement**: score from 1-5 and justify the score.
- **Documentation**: score from 1-5 and justify the score.
- **Automation Opportunity**: score from 1-5 and justify the score.
- **Bottleneck Removal**: score from 1-5 and justify the score.
...
```md
# Operations Engine Decision Memo
