...
Evaluate trading plans through risk, position sizing, invalidation, exposure, and discipline controls.

## When to use this engine

Use this engine when the Council must make or review a **trading risk decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Risk Per Trade**: score from 1-5 and justify the score.
- **Invalidation Clarity**: score from 1-5 and justify the score.
- **Reward-To-Risk**: score from 1-5 and justify the score.
- **Exposure Correlation**: score from 1-5 and justify the score.
- **Liquidity Conditions**: score from 1-5 and justify the score.
- **News Risk**: score from 1-5 and justify the score.
- **Journal Quality**: score from 1-5 and justify the score.

## Guardrails

- Educational analysis only. Never provide guaranteed profit claims, personal investment advice, or instructions to over-leverage.
...
```md
# Trading Risk Engine Decision Memo
