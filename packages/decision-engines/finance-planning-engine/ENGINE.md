...
Evaluate budgets, runway, costs, unit economics, funding needs, and cash-flow risk.

## When to use this engine

Use this engine when the Council must make or review a **financial planning decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Revenue Assumptions**: score from 1-5 and justify the score.
- **Cost Realism**: score from 1-5 and justify the score.
- **Cash-Flow Timing**: score from 1-5 and justify the score.
- **Runway**: score from 1-5 and justify the score.
- **Sensitivity Analysis**: score from 1-5 and justify the score.
- **Risk Reserves**: score from 1-5 and justify the score.
- **Decision Triggers**: score from 1-5 and justify the score.
...
```md
# Finance Planning Engine Decision Memo
