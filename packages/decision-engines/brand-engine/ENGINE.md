...
Evaluate brand strategy, identity coherence, differentiation, emotional position, and visual direction.

## When to use this engine

Use this engine when the Council must make or review a **brand direction decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Distinctiveness**: score from 1-5 and justify the score.
- **Strategic Fit**: score from 1-5 and justify the score.
- **Memorability**: score from 1-5 and justify the score.
- **Visual Coherence**: score from 1-5 and justify the score.
- **Audience Fit**: score from 1-5 and justify the score.
- **Scalability**: score from 1-5 and justify the score.
- **Execution Quality**: score from 1-5 and justify the score.
