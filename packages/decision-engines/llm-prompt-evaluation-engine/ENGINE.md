...
Evaluate prompts, instruction hierarchy, output contracts, test cases, and failure modes.

## When to use this engine

Use this engine when the Council must make or review a **prompt quality decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Task Clarity**: score from 1-5 and justify the score.
- **Instruction Priority**: score from 1-5 and justify the score.
- **Context Economy**: score from 1-5 and justify the score.
- **Test Coverage**: score from 1-5 and justify the score.
- **Failure Mode Handling**: score from 1-5 and justify the score.
- **Output Schema**: score from 1-5 and justify the score.
- **Reuse Potential**: score from 1-5 and justify the score.
...
```md
# LLM Prompt Evaluation Engine Decision Memo
