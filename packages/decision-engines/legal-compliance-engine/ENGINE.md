...
Surface legal/compliance issues, documentation gaps, consent needs, and escalation points.

## When to use this engine

Use this engine when the Council must make or review a **legal/compliance triage decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Jurisdiction Clarity**: score from 1-5 and justify the score.
- **Data Sensitivity**: score from 1-5 and justify the score.
- **Contract Risk**: score from 1-5 and justify the score.
- **User Consent**: score from 1-5 and justify the score.
- **Record Keeping**: score from 1-5 and justify the score.
- **Escalation Need**: score from 1-5 and justify the score.
- **Operational Impact**: score from 1-5 and justify the score.

## Guardrails

- Not legal advice. Identify issues and recommend consulting a qualified professional when stakes are material.
...
```md
# Legal Compliance Engine Decision Memo
