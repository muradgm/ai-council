...
Evaluate negotiation strategy, BATNA, concessions, framing, leverage, and ethical pressure boundaries.

## When to use this engine

Use this engine when the Council must make or review a **negotiation decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Interests Clarity**: score from 1-5 and justify the score.
- **Batna Realism**: score from 1-5 and justify the score.
- **Concession Plan**: score from 1-5 and justify the score.
- **Relationship Risk**: score from 1-5 and justify the score.
- **Leverage Evidence**: score from 1-5 and justify the score.
- **Message Framing**: score from 1-5 and justify the score.
- **Ethical Boundaries**: score from 1-5 and justify the score.
...
```md
# Negotiation Engine Decision Memo
