...
Generate and evaluate product, company, feature, and campaign names against strategy and constraints.

## When to use this engine

Use this engine when the Council must make or review a **naming decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Meaning**: score from 1-5 and justify the score.
- **Sound**: score from 1-5 and justify the score.
- **Memorability**: score from 1-5 and justify the score.
- **Category Fit**: score from 1-5 and justify the score.
- **International Usability**: score from 1-5 and justify the score.
- **Searchability**: score from 1-5 and justify the score.
- **Risk Of Confusion**: score from 1-5 and justify the score.
