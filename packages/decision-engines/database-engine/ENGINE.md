...
Evaluate database choice, indexing, query patterns, consistency needs, and operational risk.

## When to use this engine

Use this engine when the Council must make or review a **database decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Workload Fit**: score from 1-5 and justify the score.
- **Consistency Model**: score from 1-5 and justify the score.
- **Query Efficiency**: score from 1-5 and justify the score.
- **Operational Complexity**: score from 1-5 and justify the score.
- **Migration Path**: score from 1-5 and justify the score.
- **Backup Strategy**: score from 1-5 and justify the score.
- **Cost**: score from 1-5 and justify the score.
