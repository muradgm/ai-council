...
Evaluate API boundaries, contracts, error semantics, versioning, and developer experience.

## When to use this engine

Use this engine when the Council must make or review a **API design decision**. It is designed for decisions where tradeoffs, risk, and evidence quality matter more than quick surface-level answers.
...
- **Contract Clarity**: score from 1-5 and justify the score.
- **Resource Boundaries**: score from 1-5 and justify the score.
- **Error Handling**: score from 1-5 and justify the score.
- **Versioning**: score from 1-5 and justify the score.
- **Security**: score from 1-5 and justify the score.
- **Observability**: score from 1-5 and justify the score.
- **Developer Experience**: score from 1-5 and justify the score.
...
```md
# API Design Engine Decision Memo
